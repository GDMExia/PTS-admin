<template>
  <div>
    <Form @submit.native.prevent="()=>{}" ref="CreateForm" :model="formInline" :rules="ruleInline" :label-width="80">
      ...
      <FormItem :label="'时间段'+(index+1)" prop="amusementItemTimeRequestList" v-for="(item,index) of formInline.amusementItemTimeRequestList" :key="index">
        <Row>
          <Col span="8">
            <FormItem label="" :prop="'beginTime'+index">
          ...
          <Col span="12">
            <FormItem label="至" :prop="'endTime'+index" :label-width='40'>
  ...
  methods: {
    ...
    changeStart(val,index){
      ...
      if(val>this.formInline.amusementItemTimeRequestList[index].endTime&&this.formInline.amusementItemTimeRequestList[index].endTime!=''){
        ...
        // this.formInline.amusementItemTimeRequestList[index].beginTime=val.toString()
      }
    },
    changeEnd(val,index){
      let a=typeof this.formInline.amusementItemTimeRequestList[index].beginTime
      console.log(this.formInline)
      if(val<this.formInline.amusementItemTimeRequestList[index].beginTime){
        ...
        // this.formInline.amusementItemTimeRequestList[index].endTime=val.toString()
      }
    },
    add(){
