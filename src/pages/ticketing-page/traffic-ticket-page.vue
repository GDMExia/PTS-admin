...
import CreateForm from "./forms/traffic/create-form"
import CreateFormModel from "./model/traffic/create-form";
import SetForm from "./forms/traffic/set"
import SetFormModel from "./model/traffic/set";
import pageInfo from "@/libs/page-info"
import moment from "moment"
import { trafficcolumns , gettrafficData , gettrafficPrice , settrafficPrice , settrafficdate } from "./api";
export default {
  components:{
    Tables,
    ModelDialog,
  ...
  methods: {
    ...
    getPrice(){
      gettrafficPrice({token:this.$store.state.user.token}).then((res)=>{
        if(res.data.code==="1000"){
