...
import CreateForm from "./forms/bus/create-form"
import CreateFormModel from "./model/bus/create-form";
import SetForm from "./forms/bus/set"
import SetFormModel from "./model/bus/set";
import pageInfo from "@/libs/page-info"
import moment from "moment"
import { buscolumns , getbusData , getbusPrice , setbusPrice , setbusdate } from "./api";
export default {
  components:{
    Tables,
    ModelDialog,
  ...
  methods: {
    ...
    getPrice(){
      getbusPrice({token:this.$store.state.user.token}).then((res)=>{
        if(res.data.code==="1000"){
