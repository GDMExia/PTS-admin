<template>
  <div>
    <Form @submit.native.prevent="()=>{}" ref="CreateForm" :model="formInline" :rules="ruleInline" :label-width="100">
      <Row>
        <Col span="10">
          <FormItem label="商家ID" prop="title">
      ...
      <Row>
        <Col span="10">
          <FormItem label="优惠券名称" prop="intro">
      ...
      <Row>
        <Col span="10">
          <FormItem label="积分兑换" prop="avegmoney">
      ...
      <Row>
        <Col span="14">
          <FormItem label="库存" prop="address">
            <Input type='text' v-model="formInline.address" placeholder="请输入具体地址"></Input>
          </FormItem>
        </Col>
      </Row>
      <Row>
        <Col span="8">
          <FormItem label="使用期限" prop="date">
            <DatePicker type='date' v-model="formInline.date"/>
          </FormItem>
        </Col>
      </Row>
    </Form>
