...
// 搜索参数 转 base64
// encode json object with base64
// params: json object
export const ObjectEncodeBase64 = (data) => {
  if (typeof data === 'object') {
    let stringObject = JSON.stringify(data)
    // console.log(JSON.stringify(data))
    // console.log(Buffer.from(stringObject, 'utf8').toString('base64'))
    return Buffer.from(stringObject, 'utf8').toString('base64')
  }
}